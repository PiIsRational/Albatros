...
class Treesearch
{
    ...
    public void Test(int Iterations , TrainingPosition[] Positions)
    {
        for (int i = 0; i < Iterations; i++)
        {
            ...
            ValueNet.BackPropagationHalfkp(Positions, 0.1f);
            ValueNet.setHalfkpNet(new float[][][,] { ValueNet.HalfkpWeigthChanges }, new float[][][] { ValueNet.HalfkpBiasChange }, new float[][,] { ValueNet.HalfkpMatrixChange }, new float[][] { ValueNet.HalfkpMatrixBiasChange }, 0);
