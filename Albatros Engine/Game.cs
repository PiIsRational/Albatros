...
class Game
{
    ...
    public string TestPosition = "rnbqkbnr/2pp1Qpp/p7/1p2p3/2B1P3/8/PPPP1PPP/RNB1K1NR b KQkq - 0 4";
    public string TestPosition2 = "rnb1kbnr/ppp2ppp/8/8/8/PP6/5PPP/5q1K w kq - 0 14";
    public byte[,] Board;
    ...
    public int PlayingPosCount = 100000;
    public int TrainingSampleSize = 100000;
    public int GameLength = 400;
    public string NetName = "ValueNet.nnue";
    public int NodeCount = 400;
